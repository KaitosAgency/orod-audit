...
* **Google Knowledge Panel :** Travailler à l'émergence du "Knowledge Panel" (l'encart d'information à droite dans les résultats de recherche Google lorsqu'on tape "OROD"). Il faut s'assurer que tous les réseaux sociaux officiels (LinkedIn, Facebook, Instagram) sont liés et que les informations de l'entreprise sont cohérentes sur l'ensemble du web pour encourager Google à l'afficher.
* **Création d'une page Wikidata :** Plus accessible qu'une page Wikipédia, la création d'une fiche Wikidata pour l'entreprise OROD reste un signal de confiance ("Trust Signal") intéressant pour prouver aux moteurs de recherche qu'il s'agit d'une véritable institution, bien que son poids algorithmique direct soit moins puissant qu'auparavant.
