...
* **Google Knowledge Panel :** On ne « revendique » pas un panneau comme un simple paramétrage : Google affiche un encart lorsque l'entité atteint un seuil de notoriété et de cohérence des signaux. L’objectif est de **travailler à l’émergence** du panneau en consolidant les profils officiels (Google Business Profile si pertinent, Search Console, réseaux sociaux vérifiés) et les informations structurées cohérentes. Lorsqu’un panneau existe : demander des **modifications** via les outils Google prévus et maintenir les liens vers les réseaux officiels (LinkedIn, Facebook, Instagram).
* **Création ou enrichissement Wikidata :** Une entrée **Wikidata** (souvent plus accessible qu’une page Wikipédia, soumise à des critères de notoriété stricts) peut aider à **structurer l’entité** OROD pour le graphe de connaissances. En pratique, l’impact direct sur le classement est **modeste et indirect** comparé à Wikipédia ou aux signaux majeurs (mentions, presse, liens de qualité) ; il s’agit surtout d’un **complément** pour clarifier nom, SIREN, liens canoniques vers le site, etc., sans le surestimer comme levier miracle.
