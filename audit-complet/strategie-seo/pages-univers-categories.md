...
Pour un site e-commerce comme OROD, l'objectif stratégique idéal est le **niveau AA**. Il permet d'obtenir la majorité des bénéfices SEO liés à l'accessibilité (code propre, balises sémantiques, attributs alt, navigation claire) tout en restant compatible avec un design et une image de marque exigeants. Viser le **niveau AAA** (contrastes souvent à 7:1, contraintes très fortes sur le texte dans les images et sur certains composants) reste possible pour des acteurs très réglementés, mais il est **beaucoup plus coûteux à atteindre et à maintenir** ; pour un e-commerce grand public / institutionnel, le **rapport effort / bénéfice** est en général meilleur en **AA bien exécuté** qu'en AAA exhaustif, sans bonus SEO additionnel garanti de la part de Google.
